 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint = 
		  ...
		  Person1 p1 = new Person1("Juan Rodriguez");
		  toPrint += p1.toString("jrodriguez325");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Divij");
		  toPrint += p2.toString("dsachdeva6");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Morgan Powers");
		  toPrint += p3.toString("mpowers42");
